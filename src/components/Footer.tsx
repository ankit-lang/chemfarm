...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#012B37] text-white border-t border-[#2084A0]/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 text-center md:text-left">
        ...
        <div className="lg:col-span-2 space-y-4 flex flex-col items-center md:items-start">
          <Link href="/" className="inline-block group">
            <div className="px-3.5 py-2 bg-white shadow-md border border-slate-200/80 inline-block group-hover:scale-105 transition-transform duration-300">
              <img
                src="/logo/logo.png"
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center md:justify-start gap-4 text-xs text-slate-300">
            <div className="flex items-center space-x-1.5">
              <ShieldCheck className="w-4 h-4 text-[#2084A0]" />
              <span>ISO Certified</span>
            </div>
            <div className="flex items-center space-x-1.5">
              <Globe className="w-4 h-4 text-[#2084A0]" />
              <span>Global Exporter</span>
            </div>
            <div className="flex items-center space-x-1.5">
              <Award className="w-4 h-4 text-[#2084A0]" />
        ...
        <div className="flex flex-col items-center md:items-start">
          <h4 className="text-white font-semibold text-sm font-montserrat uppercase tracking-wider mb-4 border-b-2 md:border-b-0 md:border-l-2 border-[#2084A0] pb-1 md:pb-0 md:pl-2">
            Quick Links
          </h4>
          <ul className="space-y-2.5 text-sm text-slate-300 flex flex-col items-center md:items-start">
            <li>
              <Link href="/" className="hover:text-[#2084A0] transition-colors">
                Home
              </Link>
            </li>
            <li>
              <Link href="/about" className="hover:text-[#2084A0] transition-colors">
                About Us & Our Story
              </Link>
            </li>
            <li>
              <Link href="/products" className="hover:text-[#2084A0] transition-colors">
                Products Catalogue
              </Link>
            </li>
            <li>
              <Link href="/quality" className="hover:text-[#2084A0] transition-colors">
                Quality & Certifications
              </Link>
            </li>
            <li>
              <Link href="/contact" className="hover:text-[#2084A0] transition-colors">
        ...
        <div className="space-y-4 flex flex-col items-center md:items-start w-full">
          <h4 className="text-white font-semibold text-sm font-montserrat uppercase tracking-wider border-b-2 md:border-b-0 md:border-l-2 border-[#2084A0] pb-1 md:pb-0 md:pl-2">
            Head Office
          </h4>

          <ul className="space-y-3 text-xs text-slate-300 flex flex-col items-center md:items-start">
            <li className="flex flex-col md:flex-row items-center md:items-start space-y-1 md:space-y-0 md:space-x-2.5 text-center md:text-left">
              <MapPin className="w-4 h-4 text-[#2084A0] flex-shrink-0 mt-0.5" />
            ...
            <li className="flex items-center space-x-2.5 justify-center md:justify-start">
              <Phone className="w-4 h-4 text-[#2084A0] flex-shrink-0" />
              <div className="space-x-1">
                <a href="tel:+918800642621" className="hover:underline hover:text-[#2084A0]">+91 8800642621</a>
                <span>,</span>
                <a href="tel:+919871450429" className="hover:underline hover:text-[#2084A0]">+91 9871450429</a>
              </div>
            </li>
            <li className="flex items-center space-x-2.5 justify-center md:justify-start">
              <Mail className="w-4 h-4 text-[#2084A0] flex-shrink-0" />
              <a href="mailto:sales@chemfarm-international.com" className="hover:underline hover:text-[#2084A0]">sales@chemfarm-international.com</a>
            </li>
            <li className="flex items-center space-x-2.5 justify-center md:justify-start">
          ...
          <div className="pt-2 w-full max-w-xs md:max-w-none">
            ...
            <form onSubmit={handleSubscribe} className="flex justify-center">
              <input
                ...
                required
                className="w-full bg-[#033645] border border-[#2084A0]/50 text-xs text-white placeholder-slate-400 px-3 py-2 rounded-l-md focus:outline-none focus:border-[#2084A0]"
              />
              <button
                type="submit"
                className="bg-[#2084A0] hover:bg-[#033645] text-white px-3.5 py-2 rounded-r-md transition-colors flex items-center justify-center border border-[#2084A0]"
                title="Subscribe"
              >
            ...
            {subscribed && (
              <p className="text-[11px] text-[#2084A0] mt-1 text-center md:text-left font-medium">
      ...
      {/* Copyright Bar */}
      <div className="bg-[#02252F] border-t border-[#2084A0]/30 py-6 px-4 text-center text-xs text-slate-400">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
          ...
          <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-4 text-slate-400">
            <Link href="/quality" className="hover:text-[#2084A0]">
              Quality Assurance
            </Link>
            <span>•</span>
            <Link href="/contact" className="hover:text-[#2084A0]">
              Terms & Conditions
            </Link>
            <span>•</span>
            <Link href="/contact" className="hover:text-[#2084A0]">
